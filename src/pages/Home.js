...
const cards = [
  {
    id: 1,
    avatar:
      "https://www.pngitem.com/pimgs/m/274-2740591_bjp-logo-png-hd-bharatiya-janata-party-transparent.png",
    date: "Joined in 1828",
    header: "BJP - Bhartiye Janta Party",
    description: "Vote for me!",
  },
  {
    id: 2,
    avatar:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e6/Congresspartylogo%E2%80%A6.png/800px-Congresspartylogo%E2%80%A6.png",
    date: "Joined in 1854",
    header: "Congress - Indian National Congress",
...
const Home = () => {
  ...
  const submitVote = () => {
    axios
      .post("https://62a3181a5bd3609cee6267ff.mockapi.io/vote", {
        partyA: voteForA,
        partyB: voteForB,
      })
      .then(
